...
func (r *RelatedPartyRouter) InitRelatedPartyRouter(param *gin.RouterGroup) {
	...
	relatedPartyRouter.GET("/:related-party-id", controller.RelatedParty.Get)       //获取相关方详情
	relatedPartyRouter.PATCH("/:related-party-id", controller.RelatedParty.Update)  //修改相关方
	relatedPartyRouter.POST("", controller.RelatedParty.Create)                     //新增相关方
	relatedPartyRouter.DELETE("/:related-party-id", controller.RelatedParty.Delete) //删除相关方

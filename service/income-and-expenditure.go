...
//type IncomeAndExpenditureGetArray struct {
//	dto.ListInput
//	dto.AuthInput
...
type IncomeAndExpenditureOutput struct {
	...
	ProjectID             *int                  `json:"-"`
	ProjectExternal       *DictionaryItemOutput `json:"project" gorm:"-"`
	ContractID            *int                  `json:"-"`
	ContractExternal      *DictionaryItemOutput `json:"contract" gorm:"-"`
	FundDirection         *int                  `json:"-"`
	FundDirectionExternal *DictionaryItemOutput `json:"fund_direction" gorm:"-"`
	NameOfTheOtherParty   *string               `json:"name_of_the_other_party"`
	Kind                  *int                  `json:"-"`
